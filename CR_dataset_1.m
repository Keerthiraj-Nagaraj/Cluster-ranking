...
d=load('dataset_1.dat'); %Loading Dataset 1
m=500;
k=0;

%To form Degree diagonal matrix
...
d1=diag(deg); %Degree Diagonal matrix

%To form adjacency matrix a

%Upper triangle of  weighted adjacency matrix
b1(m,m)=0;
...
a=b1+b2; %Weighted adjacency matrix
